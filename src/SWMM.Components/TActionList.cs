...
namespace SWMM.Components
{
    [ProvideProperty("Action", typeof(Component)),
     ToolboxBitmap(typeof(TActionList), "Images.ActionList.bmp"),
     ToolboxItemFilter("System.Windows.Forms")]
    public class TActionList: Component, IExtenderProvider, ISupportInitialize
    {
        public TActionList()
        {
            this.actions = new TActionCollection(this);
            this.targets = new Dictionary<Component, TAction>();
            this.typesDescription = new Dictionary<Type, TActionTargetDescriptionInfo>();
            this.enabled = true;
        ...
        private TActionCollection actions;
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public TActionCollection Actions
        {
            get { return actions; }
        }
        #endregion                
        ...
        private Dictionary<Component, TAction> targets;

        [DefaultValue(null)]
        public TAction GetAction(Component extendee)
        {
        ...
        public void SetAction(Component extendee, TAction action)
        {
            if (!initializing)
            {
                if (extendee == null)
            ...
            if (action != null)
            {
                ...
                if (!typesDescription.ContainsKey(extendee.GetType()))
                {
                    typesDescription.Add(extendee.GetType(),
                        new TActionTargetDescriptionInfo(extendee.GetType()));
                }
        ...
        private Dictionary<Type, TActionTargetDescriptionInfo> typesDescription;
        
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public Dictionary<Type, TActionTargetDescriptionInfo> TypesDescription
        {
        ...
        private void checkInternalCollections()
        {
            ...
            foreach (TAction action in targets.Values)
            {
